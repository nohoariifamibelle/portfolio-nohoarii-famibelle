        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border-2 border-slate-100 rounded-xl p-8 hover:border-blueSurf-200 hover:shadow-lg transition-all cursor-default">
            ...
            <p className="text-slate-600 mb-4">
              React, Next.js, TypeScript pour des sites web rapides et
              évolutifs.
            </p>
          ...
          <div className="bg-white border-2 border-slate-100 rounded-xl p-8 hover:border-blueSurf-200 hover:shadow-lg transition-all cursor-default">
            ...
            <p className="text-sm text-slate-500">
              Expertise technique validée pour garantir la qualité de vos
              projets.
            </p>
          </div>
          ...
          <div className="bg-white border-2 border-slate-100 rounded-xl p-8 hover:border-blueSurf-200 hover:shadow-lg transition-all cursor-default">
            ...
            <p className="text-sm text-slate-500">
              PME et entrepreneurs accompagnés dans leur transformation
              digitale.
            </p>
          </div>
        </div>
